...
#include "../../../setting/vscuserstatus.h"
...
void *VSCUserStatus::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VSCUserStatus.stringdata))
