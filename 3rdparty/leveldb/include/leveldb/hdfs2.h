...
#ifndef LIBHDFS_HDFS2_H
#define LIBHDFS_HDFS2_H
...
extern  "C" {
    ...
    /** 
     * hdfsCreateDirectoryHdfs - Make the given file and all non-existent
     * parents into directories.
     * @param fs The configured filesystem handle.
     * @param path The path of the directory. 
     * @return Returns 0 on success, -1 on error. 
     */
    int hdfsCreateDirectoryHdfs(hdfsFS fs, const char* path);
