...
#include "../../../include/media_management/streamuri.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ONVIF__StreamUri_t, stringdata) + ofs \
...
const QMetaObject ONVIF::StreamUri::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ONVIF__StreamUri.data,
      qt_meta_data_ONVIF__StreamUri,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ONVIF__StreamUri.stringdata))
