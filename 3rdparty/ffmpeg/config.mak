...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-vaapi --disable-programs --disable-static --enable-shared --prefix=/home/ubu/work/ve/linux
...
CC_IDENT=gcc 4.8 (Ubuntu/Linaro 4.8.1-10ubuntu9)
ARCH=x86
CC=gcc
CXX=g++
AS=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wno-maybe-uninitialized
