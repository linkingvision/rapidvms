...
- (void)setWindow:(SDL_Window *)newWindow
{
    ...
    if (newWindow) {
        ...
        NSView* contentView;
        if (windowdata->urhoPlaceholderView)
        {
            contentView = windowdata->urhoPlaceholderView;
        }
        else
        {
...
Cocoa_GL_GetDrawableSize(_THIS, SDL_Window * window, int * w, int * h)
{
    ...
    if (windata->urhoPlaceholderView)
        contentView = windata->urhoPlaceholderView;
    else
        contentView = [windata->nswindow contentView];
