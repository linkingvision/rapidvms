...
int RemoteDiscoveryBindingProxy::Hello(ns1__HelloType *tdn__Hello, ns1__ResolveType *tdn__HelloResponse)
{	struct soap *soap = this;
	struct __ns10__Hello soap_tmp___ns10__Hello;
	const char *soap_action = NULL;
	soap_action = "http://www.onvif.org/ver10/network/wsdl/Hello";
	soap->encodingStyle = NULL;
	soap_tmp___ns10__Hello.tdn__Hello = tdn__Hello;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__Hello(soap, &soap_tmp___ns10__Hello);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns10__Hello(soap, &soap_tmp___ns10__Hello, "-ns10:Hello", NULL)
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tdn__HelloResponse->soap_get(soap, "tdn:HelloResponse", "ns1:ResolveType");
	if (soap->error)
...
int RemoteDiscoveryBindingProxy::Bye(ns1__ByeType *tdn__Bye, ns1__ResolveType *tdn__ByeResponse)
{	struct soap *soap = this;
	struct __ns10__Bye soap_tmp___ns10__Bye;
	const char *soap_action = NULL;
	soap_action = "http://www.onvif.org/ver10/network/wsdl/Bye";
	soap->encodingStyle = NULL;
	soap_tmp___ns10__Bye.tdn__Bye = tdn__Bye;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__Bye(soap, &soap_tmp___ns10__Bye);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__Bye(soap, &soap_tmp___ns10__Bye, "-ns10:Bye", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_begin_recv(soap)
	 ...
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	tdn__ByeResponse->soap_get(soap, "tdn:ByeResponse", "ns1:ResolveType");
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
