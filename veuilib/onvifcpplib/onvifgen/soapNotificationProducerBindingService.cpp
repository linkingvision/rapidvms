...
NotificationProducerBindingService::NotificationProducerBindingService(const struct soap &_soap) :soap(_soap)
{ }
...
{	NotificationProducerBindingService *dup = SOAP_NEW_COPY(NotificationProducerBindingService(*(struct soap*)this));
	return dup;
}
...
static int serve___ns5__Subscribe(NotificationProducerBindingService*);
static int serve___ns5__GetCurrentMessage(NotificationProducerBindingService*);

int NotificationProducerBindingService::dispatch()
{	soap_peek_element(this);
	if (!soap_match_tag(this, this->tag, "wsnt:Subscribe"))
		return serve___ns5__Subscribe(this);
	if (!soap_match_tag(this, this->tag, "wsnt:GetCurrentMessage"))
		return serve___ns5__GetCurrentMessage(this);
	return this->error = SOAP_NO_METHOD;
}

static int serve___ns5__Subscribe(NotificationProducerBindingService *soap)
{	struct __ns5__Subscribe soap_tmp___ns5__Subscribe;
	...
	soap_default___ns5__Subscribe(soap, &soap_tmp___ns5__Subscribe);
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->Subscribe(soap_tmp___ns5__Subscribe.wsnt__Subscribe, &wsnt__SubscribeResponse);
	if (soap->error)
		return soap->error;
...
static int serve___ns5__GetCurrentMessage(NotificationProducerBindingService *soap)
{	struct __ns5__GetCurrentMessage soap_tmp___ns5__GetCurrentMessage;
	...
	soap_default___ns5__GetCurrentMessage(soap, &soap_tmp___ns5__GetCurrentMessage);
	soap->encodingStyle = NULL;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->GetCurrentMessage(soap_tmp___ns5__GetCurrentMessage.wsnt__GetCurrentMessage, &wsnt__GetCurrentMessageResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
