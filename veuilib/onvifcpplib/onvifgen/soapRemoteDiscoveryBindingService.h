...
{ public:
	...
	virtual	int Hello(ns1__HelloType *tdn__Hello, ns1__ResolveType *tdn__HelloResponse){return SOAP_OK;};

	/// Web service operation 'Bye' (returns error code or SOAP_OK)
	virtual	int Bye(ns1__ByeType *tdn__Bye, ns1__ResolveType *tdn__ByeResponse){return SOAP_OK;};
};
#endif
