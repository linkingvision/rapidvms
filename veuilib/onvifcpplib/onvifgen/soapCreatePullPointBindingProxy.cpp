...
CreatePullPointBindingProxy::CreatePullPointBindingProxy(const struct soap &_soap) : soap(_soap)
{ }
...
const SOAP_ENV__Header *CreatePullPointBindingProxy::soap_header()
{	return this->header;
}

const SOAP_ENV__Fault *CreatePullPointBindingProxy::soap_fault()
{	return this->fault;
}
...
int CreatePullPointBindingProxy::CreatePullPoint(_wsnt__CreatePullPoint *wsnt__CreatePullPoint, _wsnt__CreatePullPointResponse *wsnt__CreatePullPointResponse)
{	struct soap *soap = this;
	...
	soap_tmp___ns8__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns8__CreatePullPoint(soap, &soap_tmp___ns8__CreatePullPoint);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns8__CreatePullPoint(soap, &soap_tmp___ns8__CreatePullPoint, "-ns8:CreatePullPoint", NULL)
