...
int PullPointSubscriptionBindingProxy::PullMessages(_tev__PullMessages *tev__PullMessages, _tev__PullMessagesResponse *tev__PullMessagesResponse)
{	struct soap *soap = this;
	...
	soap_tmp___ns2__PullMessages.tev__PullMessages = tev__PullMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__PullMessages(soap, &soap_tmp___ns2__PullMessages);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns2__PullMessages(soap, &soap_tmp___ns2__PullMessages, "-ns2:PullMessages", NULL)
...
int PullPointSubscriptionBindingProxy::Seek(_tev__Seek *tev__Seek, _tev__SeekResponse *tev__SeekResponse)
{	struct soap *soap = this;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns2__Seek.tev__Seek = tev__Seek;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__Seek(soap, &soap_tmp___ns2__Seek);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__Seek(soap, &soap_tmp___ns2__Seek, "-ns2:Seek", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
int PullPointSubscriptionBindingProxy::SetSynchronizationPoint(_tev__SetSynchronizationPoint *tev__SetSynchronizationPoint, _tev__SetSynchronizationPointResponse *tev__SetSynchronizationPointResponse)
{	struct soap *soap = this;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns2__SetSynchronizationPoint.tev__SetSynchronizationPoint = tev__SetSynchronizationPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__SetSynchronizationPoint(soap, &soap_tmp___ns2__SetSynchronizationPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__SetSynchronizationPoint(soap, &soap_tmp___ns2__SetSynchronizationPoint, "-ns2:SetSynchronizationPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
