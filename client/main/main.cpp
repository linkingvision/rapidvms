...
#ifdef WIN32
#ifndef _WIN64
	astring strLoggerPath = "C:\\vidstor\\logs\\";
#else
	astring strLoggerPath = "C:\\vidstor64\\logs\\";
#endif
#else
	astring strLoggerPath = "ve/vidstor/logs/";
#endif
	Poco::File file1(strLoggerPath);
	file1.createDirectories();
	astring strLoggerFile = strLoggerPath + "opencvr.log"
