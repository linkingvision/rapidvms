...
NotificationProducerBindingProxy::NotificationProducerBindingProxy(const struct soap &_soap) : soap(_soap)
{ }
...
int NotificationProducerBindingProxy::Subscribe(_wsnt__Subscribe *wsnt__Subscribe, _wsnt__SubscribeResponse *wsnt__SubscribeResponse)
{	struct soap *soap = this;
	...
	soap_tmp___ns5__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__Subscribe(soap, &soap_tmp___ns5__Subscribe);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put___ns5__Subscribe(soap, &soap_tmp___ns5__Subscribe, "-ns5:Subscribe", NULL)
...
int NotificationProducerBindingProxy::GetCurrentMessage(_wsnt__GetCurrentMessage *wsnt__GetCurrentMessage, _wsnt__GetCurrentMessageResponse *wsnt__GetCurrentMessageResponse)
{	struct soap *soap = this;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns5__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__GetCurrentMessage(soap, &soap_tmp___ns5__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__GetCurrentMessage(soap, &soap_tmp___ns5__GetCurrentMessage, "-ns5:GetCurrentMessage", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
