...
class SOAP_CMAC DiscoveryLookupBindingProxy : public soap
{ public:
	...
	DiscoveryLookupBindingProxy(const struct soap&);
	...
	virtual	int Probe(ns1__ProbeType *tdn__Probe, ns1__ProbeMatchesType *tdn__ProbeResponse);
};
#endif
