/* soapNotificationConsumerBindingService.h
...
#ifndef soapNotificationConsumerBindingService_H
#define soapNotificationConsumerBindingService_H
#include "soapH.h"
class SOAP_CMAC NotificationConsumerBindingService : public soap
{ public:
	/// Constructor
	NotificationConsumerBindingService();
	/// Constructor with copy of another engine state
	NotificationConsumerBindingService(const struct soap&);
	/// Constructor with engine input+output mode control
	NotificationConsumerBindingService(soap_mode iomode);
	/// Constructor with engine input and output mode control
	NotificationConsumerBindingService(soap_mode imode, soap_mode omode);
	/// Destructor, also frees all deserialized data
	virtual ~NotificationConsumerBindingService();
	/// Delete all deserialized data (uses soap_destroy and soap_end)
	virtual	void destroy();
	/// Initializer used by constructor
	virtual	void NotificationConsumerBindingService_init(soap_mode imode, soap_mode omode);
	/// Create a copy
